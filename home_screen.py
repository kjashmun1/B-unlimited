...
class HomeScreen:
	def __init__(self, parent):
		...
		self.inpaint_screen_button = customtkinter.CTkButton(master=self.main_frame, height=100, width=400, text="Go to Inpaint Screen", border_width=2, command=self.to_inpaint_screen)
		self.inpaint_screen_button.place(relx=0.5, rely=0.3, anchor=tkinter.CENTER)

		self.edit_screen_button = customtkinter.CTkButton(master=self.main_frame, height=100, width=400, text="Go to Edit Screen", border_width=2, command=self.to_edit_screen)
